...
I am writing to enthusiastically recommend Theodoros Panagiotakopoulos for a National Interest Waiver (NIW). I am Ming-Chun Tien, the Product Engineering Manager at ASML, and I have had the privilege of witnessing his exceptional contributions to our team. I received my Ph.D. in Optoelectronics from the University of California, Berkeley, in 2009. During my Ph.D., I designed a balanced receiver with integrated electro-absorption modulators and photodetectors, demonstrated tunable optical add-drop multiplexers using micro-ring resonators and MEMS actuators, and integrated III-V semiconductor lasers on silicon for silicon photonics. From 2009 to 2011, I completed my postdoctoral research at the University of California, Santa Barbara, where I demonstrated optical ring isolators by combining non-reciprocal materials with optical ring resonators. I also demonstrated ultra-high-Q ring resonators using ultra-low loss silicon nitride waveguides and conducted meticulous research on silicon photonics. In May 2011, I began working at Intel, where I remained until September 2014. At Intel, I created precise OPC (Optical Proximity Correction) models and delivered advanced technical solutions for technology nodes at 22nm, 14nm, 10nm, and smaller. I developed script wrappers to automate data manipulation and improve process effectiveness and efficiency. I collaborated with lithography process engineers for troubleshooting and provided solutions for yield improvement based on statistical analysis. I also worked with Lithography, Integration, and Design groups to finalize process specifications (etch spec, DFM spec, etc.). Additionally, I evaluated SMO sources to improve depth of focus, MEEF, exposure latitude, and image contrast of lithography for next-generation processes. I mentored and trained junior OPC engineers. From July 2016 to May 2018, I worked at ASML Brion as a Staff Product Engineer for the Tachyon OPC modeling tool. I defined the specifications of new features for each release, provided customer training and support, and specialized in EUV optical and resist modeling. I engaged in new product development, defined required product features, performed functional testing, and provided training for customers and field application engineers (FAE). I created element design specifications for Brion's defect simulation tools and provided prototypes and required tooling for FAE. Since May 2018, I have been working as a Product Engineering Manager at ASML in Silicon Valley, where I lead the optical modeling team and specialize in EUV modeling. I define new feature specifications and provide relevant customer support.

I personally interviewed Mr. Theodoros Panagiotakopoulos for the position of Modeling Product Engineer Intern at ASML. I was impressed by his exceptional modeling skills and his ability to apply his knowledge and capabilities beyond his Ph.D. research area of material design modeling. His expertise extended to electrochemistry and semiconductors, where his deep understanding of semiconductor physics and optics, combined with innovative machine learning applications, can produce remarkable results. Notably, his GPA of 4.0/4.0, which is quite rare for a Ph.D. candidate in the USA, further demonstrated his academic excellence. From a pool of thousands of applicants eager to join the semiconductor industry in Silicon Valley, I personally selected Mr. Panagiotakopoulos for the position, so he can work on two different projects. The one was about the geometrical corner rounding effect and the other was regarding the optimization of transmission cross coefficients for the lithography. 

For the first project, which focused on the effect of geometrical corner rounding and was requested by our customer Samsung, Mr. Theodoros Panagiotakopoulos used the Tachyon software, the tool employed by ASML, and personally designed simulations for mask (the pattern to be printed on the wafer) optimization. He personally designed Finite Element Method ( FEM+ ) simulations and calculated the total run time, memory usage, and grid dependence. By performing a runtime breakdown, he was able to calculate the corner rounding run time, the render area and render edge time, as well as the EM3D time. For the contour-to-contour difference, he designed Lithography Manufacturing Check simulations (LMC+) and used the MPC layer as the golden rule for my comparison. Mr. Theodoros Panagiotakopoulos was able to verify his results by performing a stability test, which showed that increasing the geometrical corner rounding value, up to a certain point, reduces computational time without compromising the accuracy of the pattern that will be printed on the microchip's wafer. After discussing the results with R&D, this update was included in the latest Tachyon release and introduced to one of our biggest customers, Samsung.  He found that by using an updated geometrical corner rounding value, we could reduce computational time by 10% and corresponding memory usage by 3%. He wrote his own codes to extract data from large datasets, transformed them into libraries, and shared them with the company, where they were adopted by the product engineering group. Additionally, he identified a bug in the Tachyon software that was causing asymmetric jogs after applying the geometrical corner rounding algorithm and he proposed a solution to the research and development team. This result is significant because Samsung had been consistently requesting an updated geometrical corner rounding value to reduce computational time. This improvement is important because it allows them to run simulations and verify their microchip products in less time, using less memory. Consequently, they will be able to produce more microchips for their devices faster, leading to increased revenue. Increased revenue means more job opportunities, more tax income for the U.S. government, and a faster production cycle for tech products like laptops and cell phones. This is very important since Samsung was selected by the Biden-Harris Administration to receive $6.4 billion for manufacturing computer chips in Texas. Therefore, Mr. Panagiotakopoulos’s research is directly related to U.S. well-being and significantly contributes to the US economic growth.
The second project which was about the transition cross coefficient optimization it was about another customer, Intel and was very competitive and challenging due to the large amount of work that requires, and the innovative simulation design needed. Mr Panagiotakopoulos I designed rigorous M3D simulations using Tachyon software, specifically FEM+. He utilized a variety of mask patterns to calculate the optimal TCC number that yields the lowest aerial image critical dimension (AI CD) difference between the baseline model and models with fewer TCC numbers. For this purpose, he used different and mask types, such as high numerical aperture with a low refraction index mask, high numerical aperture with a binary mask (with a large refractive index contrast, making the brighter side brighter and the dark side darker), low numerical aperture with a low refraction index, and low numerical aperture with a binary mask, each with different mask patterns. These patterns included one-dimensional patterns, two-dimensional patterns, circular patterns, elliptical patterns, and polygonal patterns. He calculated the optimal TCC number, which resulted in the following improvements: a 3.3% reduction in runtime and a 40% reduction in memory usage for high numerical aperture masks with low refractive index; a 4.12% reduction in runtime and a 48.57% reduction in memory usage for binary masks with high numerical aperture; a 9.39% reduction in runtime and a 14.13% reduction in memory usage for low numerical aperture and low refractive index masks; and a 15.15% reduction in runtime and a 34.77% reduction in memory usage for low numerical aperture binary masks. All these improvements were achieved while maintaining accuracy in the aerial image within a specification of 0.1 nm and causing a shift in the x and y directions of less than 0.01 nm. After discussing the results with the research and development team, we included this update in the next Tachyon software release, and the result was also adopted by our customer Intel. Additionally, Mr Theodoros Panagiotakopoulos wrote his own Python and C++ code to extract and process data from the simulations, using a completely different approach from my previous project. He developed custom scripts to automate the data extraction, filtering, and analysis processes, allowing for efficient handling of large datasets. His result is important for our customers because they were continuously asking a way to reduce run time and memory to test their microchips before starting the production. Thery were limited to wait a lot of time and use a lot of memory, causing significant delays to the production but with Mr Panagiotakopoulso result they will be able to produce more microchips faster, increasing their revenue and making more working positions for the US people. On March 20, 2024, the Biden-Harris Administration announced the largest CHIPS and Science Act grant to date, with Intel and the U.S. Department of Commerce signing a non-binding preliminary memorandum for up to $8.5 billion in direct funding for commercial semiconductor projects. Consequently, Mr. Panagiotakopoulos’s research is directly related to a customer receiving federal funding that supports the growth of the U.S. economy.
Theodoros Panagiotakopoulos performed so well in his internship that I personally offered to extend it. However, due to his university obligations and his upcoming PhD graduation in November, he was unable to accept the extension. His exceptional skills and expertise are precisely what we need in the semiconductor industry and technology sector. We are eager to offer him a position as soon as he graduates. I am keen to have him in my team, as he can contribute highly valuable research and achieve remarkable results.
In conclusion, I am confident that Mr. Panagiotakopoulos’s exceptional expertise and groundbreaking research will make substantial contributions to the advancement of the semiconductor industry. His work aligns directly with the strategic goals of the U.S. defense and technology sectors. By accelerating microchip manufacturing through enhanced efficiency, his research has the potential to create significant job growth and solidify the U.S.’s global leadership in semiconductor technology. Given his innovative approach, exceptional modeling skills, and unwavering commitment to excellence, I wholeheartedly endorse his application for the I-140 National Interest Waiver. Please do not hesitate to contact me if you require further information.
